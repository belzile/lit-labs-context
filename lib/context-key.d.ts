 ...
 */
export declare type ContextKey<KeyType, ValueType> = KeyType & {
    __context__: ValueType;
};
/**
 * A helper type which can extract a Context value type from a Context type
 */
export declare type ContextType<Key extends ContextKey<unknown, unknown>> = Key extends ContextKey<unknown, infer ValueType> ? ValueType : never;
/**
 ...
 */
export declare function createContext<ValueType>(key: unknown): {
    __context__: ValueType;
};
