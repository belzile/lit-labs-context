 ...
 */
export declare class ContextRequestEvent<Context extends ContextKey<unknown, unknown>> extends Event implements ContextRequest<Context> {
    readonly context: Context;
    readonly callback: ContextCallback<ContextType<Context>>;
     ...
     */
    constructor(context: Context, callback: ContextCallback<ContextType<Context>>, subscribe?: boolean | undefined);
}
